...
public class BillBean implements Serializable {
    ...
    public void setSlab1Units(double slab1Units) {
        this.slab1Units = slab1Units;
    }
    ...
    public void setSlab2Units(double slab2Units) {
        this.slab2Units = slab2Units;
    }
    ...
    public void setSlab3Units(double slab3Units) {
        this.slab3Units = slab3Units;
    }
    ...
    public void setSlab4Units(double slab4Units) {
        this.slab4Units = slab4Units;
    }

    public double getSlab1Cost() {
        return slab1Cost;
    }

    public void setSlab1Cost(double slab1Cost) {
        this.slab1Cost = slab1Cost;
    }

    public double getSlab2Cost() {
        return slab2Cost;
    }

    public void setSlab2Cost(double slab2Cost) {
        this.slab2Cost = slab2Cost;
    }

    public double getSlab3Cost() {
        return slab3Cost;
    }

    public void setSlab3Cost(double slab3Cost) {
        this.slab3Cost = slab3Cost;
    }

    public double getSlab4Cost() {
        return slab4Cost;
    }

    public void setSlab4Cost(double slab4Cost) {
        this.slab4Cost = slab4Cost;
    }
